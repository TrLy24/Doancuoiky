...
public class StringUtils {
    ...
    /**
     * Splits an model.entity identifier into its parts (database and model.entity name) and returns a list containing the two elements. If the identifier doesn't contain
     * the database part then the argument <code>db</code> is used in its place and <code>source</code> corresponds to the full model.entity name.
    ...
    /**
     * Builds and returns a fully qualified name, quoted if necessary, for the given database model.entity.
     * 
     * @param db
     *            database name
     * @param entity
